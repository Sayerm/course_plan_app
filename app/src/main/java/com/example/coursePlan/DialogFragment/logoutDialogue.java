package com.example.coursePlan.DialogFragment;
...
public class logoutDialogue extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.logout_dialogue, null);
    ...
    public interface ApplyExitApp {
        void exitApp(TextView textView);
    }
