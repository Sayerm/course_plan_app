...
import com.example.coursePlan.Models.MyQuestionsModel;
...
public class ProfileQuestionsAdapter extends RecyclerView.Adapter<ProfileQuestionsAdapter.ViewHolder> {

    Context context;
    List<MyQuestionsModel> myQuestionsModelList;

    public ProfileQuestionsAdapter(Context context, List<MyQuestionsModel> myQuestionsModelList) {
        this.context = context;
        this.myQuestionsModelList = myQuestionsModelList;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        try {
            ...
            MyQuestionsModel postsModel = myQuestionsModelList.get(position);
    ...
    public int getItemCount() {
        return myQuestionsModelList.size();
    }
