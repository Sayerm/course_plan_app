package com.example.coursePlan.Adapters;
...
import com.example.coursePlan.Activities.AnothersProfile;
import com.example.coursePlan.Activities.FullQuestionActivity;
import com.example.coursePlan.Activities.MyProfileActivity;
import com.example.coursePlan.Constans.GetTimeAgo;
import com.example.coursePlan.Models.PostsModel;
...
import static com.example.coursePlan.Constans.BaseUrl.BASE_URL;
...
public class QuestionListAdapter extends RecyclerView.Adapter<QuestionListAdapter.ViewHolder> {
    ...
    public QuestionListAdapter(Context context, List<PostsModel> postsModelList) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        try {
            ...
            reference.addValueEventListener(new ValueEventListener() {
                ...
                @Override
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    holder.likeTv.setText(snapshot.getChildrenCount() + " Votes");
                }
            ...
            try {
                if (status.equals("Pending")){
                    ...
                    holder.approveLayout.setVisibility(View.GONE);
                }
            }catch (Exception e){
                e.printStackTrace();
            }
            ...
            holder.approveButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    String url=BASE_URL+"approve_question.php";
                    Volley.newRequestQueue(context).add(new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
                            Toast.makeText(context, "Approved", Toast.LENGTH_SHORT).show();
                            postsModelList.remove(holder.getAdapterPosition());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView likeTv, answerTv, shareTv, unlikeTv, userNameTv, postTimeTv, questionTv, descriptionTv, seeTV;
        ImageView likeView, answerView, shareView, unlikeView;
        LinearLayout likeButton, answerButton, shareButton, unlikeButton, wholeItemId,approveLayout,likeCommentLayout;
